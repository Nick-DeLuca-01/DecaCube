...
void Scene_CubeBack::sMovement(sf::Time dt)
{
...
void Scene_CubeBack::sAnimation()
{
}

void Scene_CubeBack::sCollision()
{
...
void Scene_CubeBack::sEnemyFaceChange(sf::Time dt)
{
	for (auto e : _enemyData.enemyManager.getEntities()) {
...
void Scene_CubeBack::sEnemyBehaviour()
{
	for (auto e : _enemyData.enemyManager.getEntities()) {
...
void Scene_CubeBack::flipper(std::shared_ptr<Entity> entity)
{
	enemyAwareMovement(entity);
}

void Scene_CubeBack::gunner(std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBack::sunAndMoon(std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBack::defender(std::shared_ptr<Entity> entity)
{
	auto& tfm = entity->getComponent<CTransform>();
...
void Scene_CubeBack::charger(std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBack::revenant(std::shared_ptr<Entity> entity)
{
	auto& sight = entity->getComponent<CSight>();
...
std::vector<Vec2> Scene_CubeBack::getAvailableNodes(Vec2 pos, std::shared_ptr<Entity> entity)
{
...
Vec2 Scene_CubeBack::pickBestNode(std::vector<Vec2> availableNodes)
{
...
Vec2 Scene_CubeBack::pickBestNode(std::vector<Vec2> availableNodes, Vec2 target)
{
	float minDistance = 1000.f;
	Vec2 closestNode;
...
Vec2 Scene_CubeBack::pickRandomNode(std::vector<Vec2> availableNodes)
{
...
void Scene_CubeBack::enemyAwareMovement(std::shared_ptr<Entity> enemy)
{
...
void Scene_CubeBack::enemyUnawareMovement(std::shared_ptr<Entity> enemy)
{
	auto& tfm = enemy->getComponent<CTransform>();
...
void Scene_CubeBack::enemyDefenceMovement(std::shared_ptr<Entity> enemy, Vec2 itemLocation)
{
	auto& tfm = enemy->getComponent<CTransform>();
	auto& pathFinding = enemy->getComponent<CPathFinding>();
	std::vector<Vec2> availableNodes;
...
void Scene_CubeBack::enemyChargeMovement(std::shared_ptr<Entity> enemy)
{
	std::vector<Vec2> availableNodes;
...
void Scene_CubeBack::enemySmoothMovement(std::shared_ptr<Entity> enemy)
{
	auto& tfm = enemy->getComponent<CTransform>();
	auto pPos = _player->getComponent<CTransform>().pos;
...
void Scene_CubeBack::enemyMovement(Vec2 distance, std::shared_ptr<Entity> enemy)
{
	auto& pathFinding = enemy->getComponent<CPathFinding>();
	auto& tfm = enemy->getComponent<CTransform>();
...
bool Scene_CubeBack::canSeePlayer(std::shared_ptr<Entity> enemy)
{
	auto& tfm = enemy->getComponent<CTransform>();
...
bool Scene_CubeBack::touchingPlayer(std::shared_ptr<Entity> entity)
{
	auto overlap = Physics::getOverlap(entity, _player);
	return (overlap.x > 0 && overlap.y > 0);
}

void Scene_CubeBack::clearBullets()
{
	for (auto bullet : _entityManager.getEntities("bullet")) {
...
void Scene_CubeBack::killPlayer()
{
...
void Scene_CubeBack::init(const std::string& path)
{
	loadLevel(path);
	registerActions();
}

void Scene_CubeBack::registerActions()
{
...
void Scene_CubeBack::spawnPlayer(sf::Vector2f pos)
{
}

void Scene_CubeBack::loadLevel(const std::string& path)
{
	_entityManager = EntityManager();
	loadFromFile(path);
}

Vec2 Scene_CubeBack::gridToMidPixel(float gridX, float gridY, std::shared_ptr<Entity> entity)
{
...
Vec2 Scene_CubeBack::midPixelToGrid(float midX, float midY, std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBack::loadFromFile(const std::string& path)
{
...
void Scene_CubeBack::playerMovement()
{
...
void Scene_CubeBack::adjustPlayerPosition()
{
}

void Scene_CubeBack::snapToGrid(std::shared_ptr<Entity> entity)
{
	auto& tfm = entity->getComponent<CTransform>();
...
bool Scene_CubeBack::canMoveInDirection(std::string direction, std::shared_ptr<Entity> entity)
{
...
sPtrEntt Scene_CubeBack::getCurrentTile(std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBack::checkIfPlayerInBounds()
{
	auto& pPos = _player->getComponent<CTransform>().pos;
...
void Scene_CubeBack::fixPlayerPos()
{
...
Vec2 Scene_CubeBack::rotateTilePosition(Vec2 prePos)
{
...
Vec2 Scene_CubeBack::rotateEntityPosition(Vec2 prePos)
{
	Vec2 newPos = prePos;
	int i = _prevRotation;
...
void Scene_CubeBack::rotateEntireFace()
{
	for (auto e : _entityManager.getEntities()) {
...
int Scene_CubeBack::changeFace(int currentFace, bool knowsPlayerPos)
{
