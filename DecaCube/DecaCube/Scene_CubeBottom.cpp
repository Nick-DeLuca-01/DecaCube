...
void Scene_CubeBottom::sMovement(sf::Time dt)
{
...
void Scene_CubeBottom::sAnimation()
{
}

void Scene_CubeBottom::sCollision()
{
...
void Scene_CubeBottom::sEnemyFaceChange(sf::Time dt)
{
	for (auto e : _enemyData.enemyManager.getEntities()) {
...
void Scene_CubeBottom::sEnemyBehaviour()
{
	for (auto e : _enemyData.enemyManager.getEntities()) {
...
void Scene_CubeBottom::sunAndMoon(std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBottom::defender(std::shared_ptr<Entity> entity)
{
	auto& tfm = entity->getComponent<CTransform>();
...
void Scene_CubeBottom::stalker(std::shared_ptr<Entity> entity)
{
	auto& tfm = entity->getComponent<CTransform>();
	auto& sight = entity->getComponent<CSight>();
	bool seesPlayer = canSeePlayer(entity);
...
void Scene_CubeBottom::revenant(std::shared_ptr<Entity> entity)
{
	auto& sight = entity->getComponent<CSight>();
...
Vec2 Scene_CubeBottom::pickBestNode(std::vector<Vec2> availableNodes)
{
...
Vec2 Scene_CubeBottom::pickBestNode(std::vector<Vec2> availableNodes, Vec2 target)
{
	float minDistance = 1000.f;
	Vec2 closestNode;
...
Vec2 Scene_CubeBottom::pickRandomNode(std::vector<Vec2> availableNodes)
{
...
void Scene_CubeBottom::enemyAwareMovement(std::shared_ptr<Entity> enemy)
{
...
void Scene_CubeBottom::enemyUnawareMovement(std::shared_ptr<Entity> enemy)
{
	auto& tfm = enemy->getComponent<CTransform>();
...
void Scene_CubeBottom::enemyDefenceMovement(std::shared_ptr<Entity> enemy, Vec2 itemLocation)
{
	auto& tfm = enemy->getComponent<CTransform>();
	auto& pathFinding = enemy->getComponent<CPathFinding>();
	std::vector<Vec2> availableNodes;
...
void Scene_CubeBottom::enemySmoothMovement(std::shared_ptr<Entity> enemy)
{
	auto& tfm = enemy->getComponent<CTransform>();
	auto pPos = _player->getComponent<CTransform>().pos;
...
void Scene_CubeBottom::enemyMovement(Vec2 distance, std::shared_ptr<Entity> enemy)
{
	auto& pathFinding = enemy->getComponent<CPathFinding>();
	auto& tfm = enemy->getComponent<CTransform>();
...
void Scene_CubeBottom::killPlayer()
{
...
void Scene_CubeBottom::init(const std::string& path)
{
	loadLevel(path);
	registerActions();
}

void Scene_CubeBottom::registerActions()
{
...
void Scene_CubeBottom::spawnPlayer(sf::Vector2f pos)
{
}

void Scene_CubeBottom::loadLevel(const std::string& path)
{
	_entityManager = EntityManager();
	loadFromFile(path);
}

Vec2 Scene_CubeBottom::gridToMidPixel(float gridX, float gridY, std::shared_ptr<Entity> entity)
{
...
Vec2 Scene_CubeBottom::midPixelToGrid(float midX, float midY, std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBottom::loadFromFile(const std::string& path)
{
...
void Scene_CubeBottom::playerMovement()
{
...
void Scene_CubeBottom::adjustPlayerPosition()
{
}

void Scene_CubeBottom::snapToGrid(std::shared_ptr<Entity> entity)
{
	auto& tfm = entity->getComponent<CTransform>();
...
bool Scene_CubeBottom::canMoveInDirection(std::string direction, std::shared_ptr<Entity> entity)
{
...
sPtrEntt Scene_CubeBottom::getCurrentTile(std::shared_ptr<Entity> entity)
{
...
void Scene_CubeBottom::checkIfPlayerInBounds()
{
	auto& pPos = _player->getComponent<CTransform>().pos;
...
void Scene_CubeBottom::fixPlayerPos()
{
...
std::string Scene_CubeBottom::getRotatedTileName(std::string name, int rotations)
{
	if (name == "DownEnd") {
		switch (rotations) {
		case 0:
...
Vec2 Scene_CubeBottom::rotateTilePosition(Vec2 prePos)
{
...
Vec2 Scene_CubeBottom::rotateEntityPosition(Vec2 prePos)
{
	Vec2 newPos = prePos;
	int i = _prevRotation;
...
void Scene_CubeBottom::rotateEntireFace()
{
	for (auto e : _entityManager.getEntities()) {
...
int Scene_CubeBottom::changeFace(int currentFace, bool knowsPlayerPos)
{
